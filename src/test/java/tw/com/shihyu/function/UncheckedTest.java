...
public class UncheckedTest {
  ...
  public void testBiConsumer() {
    map.forEach(Unchecked.warp(this::sysoutKeyAndValue));
  }
  ...
  public void testBiFunction() {
    int actual = map.computeIfPresent(5, Unchecked.warp(this::add));
  ...
  public void testBiPredicate() {
    int actual = map.filter(Unchecked.warp(this::keyEqualsValue)).size();
  ...
  public void testConsumer() {
    collection.stream().forEach(Unchecked.warp(this::sysout));
  }
  ...
  public void testFunction() {
    long actual = collection.stream().map(Unchecked.warp(this::identity)).count();
  ...
  public void testPredicate() {
    long actual = collection.stream().filter(Unchecked.warp(this::divisible)).count();
  ...
  public void testSupplier() {
    long expected = 10;
    long actual = Stream.generate(Unchecked.warp(this::random)).limit(expected).count();
